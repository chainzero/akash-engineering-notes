...
<figure><img src="../.gitbook/assets/akashProviderService.png" alt=""><figcaption></figcaption></figure>
...
Within a dedicated document in this section the [Akash IP Operator](akash-operator-overview/ip-operator-for-ip-leases.md) - a Kubernetes custom controller implementation - code is covered in detail.  In this document the interaction with the IP Operator from the Akash Provider service is covered.
